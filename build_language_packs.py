#!/usr/bin/env python3
"""Build EasyBlog language pack ZIPs — one per locale, with Joomla XML manifest."""
...
\t<name>EasyBlog - Language Pack {name} ({locale})</name>
...
\t<description>{name} Language Pack for EasyBlog {VERSION}</description>
\t<fileset>
...
for locale in locales:
    ...
    manifest_name = f'easyblog_{locale}.xml'

    zip_path = DIST / f'com_easyblog_{locale}.zip'
